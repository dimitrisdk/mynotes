...
| 2026-06-02 09:48 UTC | Model update σε όλα τα Hermes profiles | Completed | Panagia, Petros, Ioudas, Samson σε model.default=gpt-5.5 και provider=openai-codex. OpenAI Codex auth διαθέσιμο σε όλα, smoke tests OK, gateways Panagia/Petros/Samson restarted. |
